...
const Price = ({ getClient, client, createPrice, getPrice, price }) => {
  ...
  var { user_id, State, city, ruralPrice, urbanPrice } = formData;
      ...
      <table class="table-fixed text-left w-full ">
        <thead className="bg-black flex text-white w-full">
          <tr class="flex w-full mb-4">
            <th class="w-1/5 ml-1 ...">S.No</th>
            <th class="w-1/5 ...">Company Name</th>
            <th class="w-1/5 ...">Contact Person</th>
            ...
            client.map((e) => {
              return (
                <tr
                  ...
                  key={e._id}
                >
                  <td className="w-1/4 ml-1">{count++}</td>
                  <td className="w-1/4">
                    {e.profile &&
