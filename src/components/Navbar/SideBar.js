...
import PackagePrice from "../ClientRoute/PackagePrice";
  ...
  return (
    <Router>
      <div className="flex flex-wrap bg-gray-100 w-full h-screen">
        <div className="w-3/12 bg-gray-900 rounded p-3 shadow-lg">
          <div className="flex items-center space-x-4 p-2 mb-5">
            ...
            />
            <div>
              <h4 className="font-semibold text-lg text-gray-100 capitalize font-poppins tracking-wide">
                {user.user.name}
              </h4>
        ...
        <div className="w-9/12">
          <div className="p-4 text-gray-500">
            <Switch>
              ...
              />
              <PrivateRoute exact path="/packageprice" component={PackagePrice} />
