...
const Verify = ({uploadAddressCheck,getReport ,report, report_id,loading}) => {
    const [file,setFile] = useState('');
    const [control, setControl] = useState(false)
if(report_id !== null){
  var result=  report.find(d =>{ return d.report_id === report_id})
}
    ...
    <div class=" mb-10 bg-gray-100">
      <div class="  sm:my-auto">
        ...
        >
          ...
          <form className='flex justify-between mt-10' onSubmit={e => address(e)}>
...
export default connect(mapStateToProps,{uploadAddressCheck, getReport})(Verify);
